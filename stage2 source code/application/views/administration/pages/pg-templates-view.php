...
function initDataTables(){	
 $('#example').dataTable( {
                    ...
                    /*{
                        ...
                        "fnClick": function ( nButton, oConfig, oFlash )
                        {
                            cb.colorbox({
                                ...
                                width:"90%",
                                height:'75%',
                                href: '<?PHP echo base_url();?>administration/templates/add',
                                onClosed:function()
                                {
		...
		"aoColumns": [
						...
						{ "sWidth": "2%","bSortable": false, "fnRender": function(obj){return gen_link('administration/templates/del/','del.gif',obj.aData[4],true);}}
					 ],					
