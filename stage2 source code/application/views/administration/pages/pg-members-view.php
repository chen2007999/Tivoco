...
function initDataTables(){	
 $('#example').dataTable( {
		...
		"aoColumns": [					
                        ...
                        { "sWidth": "auto" },
                        { "sWidth": "auto" },
                        { "sWidth": "2%","bSortable": false, "fnRender": function(obj){return gen_link('administration/members/edit/','edit.gif',obj.aData[8],false);}},
						{ "sWidth": "2%","bSortable": false, "fnRender": function(obj){return gen_link('administration/members/del/','del.gif',obj.aData[9],true);}}
					 ],					
