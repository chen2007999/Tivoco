            ...
            <tr>
                <td>
                    ...
                    <p>
                        ...
                        <input size="60" name="university" id="university" type="text" value="<?PHP echo set_value('university',$row->university);?>"/ class="validate[required]">
                    </p>
                    ...
                    <p>
                        ...
                        <input size="60" name="major" id="major" type="text" value="<?PHP echo set_value('major',$row->major);?>" class="validate[required]"/>
                    </p>
                </td>
            </tr>
            <tr>
                <td>
                    <p>
                        ...
                        <textarea class="validate[required]" name="description" id="description" cols="" rows="" style="width:100%;height:350px;"><?PHP echo set_value('description',$row->description);?></textarea>
                    </p>
