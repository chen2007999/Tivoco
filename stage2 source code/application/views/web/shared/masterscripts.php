...
<script>
	...
	j(document).ready(function(){
		...
		j("#forgotPasswordFrm,#membersProfileFrm,#loginFrm,#memberSignupFrm,#updatePasswordFrm,#feedbackFrm,#newMsgFrm").validationEngine({
    ...
    var cb = jQuery.noConflict();
	 ...
	 /*cb(document).ready(function(){
        // color box initialization code
         cb(".iframe_auto_w_h").live('click', function(e)
         {
            e.preventDefault();
            cb.colorbox({
                iframe:true,
                ...
                initialHeight:32,
                opacity:0.6,
                href:cb(this).attr('href'),
                fastIframe:false,
                onClosed:function()
                {
                    if (typeof top_navigation == 'function')
                    {
                        top_navigation();
                    }
                    if (typeof sub_navigation == 'function')
                    {
                        sub_navigation();
                    }
                }
       ...
       /* cb(".open_popup").colorbox({
         ...
         /*
         cb(".iframe_auto_w_h_refresh").live('click', function(e) {
            cb.colorbox({
                iframe:true,
                innerWidth:32,
                innerHeight:32,
