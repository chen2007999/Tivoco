...
$tinybrowser['path']['image'] = '/assets/useruploads/images/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = '/assets/useruploads/media/'; // Media files location
$tinybrowser['path']['file']  = '/assets/useruploads/files/'; // Other files location
