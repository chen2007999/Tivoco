...
<script>
	...
	j(document).ready(function(){
		...
		j("#forgotPasswordFrm,#membersProfileFrm,#loginFrm,#memberSignupFrm,#updatePasswordFrm,#feedbackFrm").validationEngine({
...
function top_navigation()
{
        ...
        var resultDiv = "top_navigation";

        j.ajax
        ({
            /*beforeSend: function()
             {
             j("#"+resultDiv).html('<span class="colr2"><a href="#">Please wait...</a></span>');
             },*/
            type: "POST",
            url: "<?PHP echo base_url();?>home/top_nav",
            cache: false,
            success: function(html)
            {
                j("#"+resultDiv).html(html);
                if(document.getElementById("activation_popup"))
                {
                    var element = document.getElementById("activation_popup");
