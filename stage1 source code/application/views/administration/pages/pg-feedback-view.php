...
function initDataTables(){	
 $('#example').dataTable( {
                    ...
                    /*{
                        ...
                        "fnClick": function ( nButton, oConfig, oFlash )
                        {
                            cb.colorbox({
                                ...
                                width:"90%",
                                height:'75%',
                                href: '<?PHP echo base_url();?>administration/feedback/add',
                                onClosed:function()
                                {
		...
		"aoColumns": [
                        ...
                        { "sWidth": "auto" },
                        { "sWidth": "auto" },
                       /* { "sWidth": "2%","bSortable": false, "fnRender": function(obj){return gen_link('administration/feedback/edit/','edit.gif',obj.aData[3],false);}},*/
						{ "sWidth": "2%","bSortable": false, "fnRender": function(obj){return gen_link('administration/feedback/del/','del.gif',obj.aData[4],true);}}
					 ],					
		...
		"sAjaxSource": "<?PHP echo base_url()?>administration/feedback/grid/"
