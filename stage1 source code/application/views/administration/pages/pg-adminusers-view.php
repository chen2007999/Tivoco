...
function initDataTables(){	
 $('#example').dataTable( {
				...
				[
                    {
                        ...
                        "fnClick": function ( nButton, oConfig, oFlash )
                        {
                            cb.colorbox({
                                ...
                                width:"90%",
                                height:'75%',
                                href: '<?PHP echo base_url();?>administration/adminusers/add',
                                onClosed:function()
                                {
		...
		"aoColumns": [					
						{ "sWidth": "auto" },
						{ "sWidth": "auto" },
						{ "sWidth": "auto", "fnRender":function(obj){return status(obj.aData[2]);}},
                        { "sWidth": "auto" },
                        { "sWidth": "auto" },
                        { "sWidth": "auto" },
                        { "sWidth": "auto" },
						{ "sWidth": "2%","bSortable": false, "fnRender": function(obj){return gen_link('administration/adminusers/edit/','edit.gif',obj.aData[7],false);}},
						{ "sWidth": "2%","bSortable": false, "fnRender": function(obj){return gen_link('administration/adminusers/del/','del.gif',obj.aData[8],true);}}
					 ],					
		...
		"sAjaxSource": "<?PHP echo base_url()?>administration/adminusers/grid/"
...
<table id="example" width="100%" cellpadding="0" cellspacing="0" class="dataTableGridNJ">
    <thead>
      <tr>
        ...
        <th align="left"><strong>User Email</strong></th>
        <th align="left"><strong>Status</strong></th>
        <th align="left"><strong>No of visits</strong></th>
        <th align="left"><strong>Last Login Date</strong></th>
        <th align="left"><strong>Last Login IP</strong></th>
